        ...
        <div className="panel pad">
          <div className="formwrap">
            ...
            <div className="split">
              ...
              <div className="col">
                <div className="sectlabel">Documentazione Archiviata</div>
            ...
            <button className="btn dark wide" onClick={() => savePropertyToDB(p)}>Salva Modifiche Immobile</button>
          </div>
        </div>
      )}
...
.ipb .costrow{ display:grid; grid-template-columns:30px 1.6fr 1fr .9fr 32px; gap:12px; align-items:center; padding:12px 8px; border-top:1px solid var(--border); }
...
.ipb .donutcol{ background:var(--inset); display:flex; flex-direction:column; align-items:center; gap:16px; }
.ipb .donutwrap{ position:relative; width:200px; height:200px; flex:none; }
.ipb .donutc{ position:absolute; inset:0; display:grid; place-items:center; text-align:center; pointer-events:none; }
.ipb .leglist{ width:100%; max-height:150px; overflow-y:auto; }
.ipb .legrow{ display:flex; align-items:center; justify-content:space-between; padding:8px 10px; margin:0 -10px; border-radius:8px; }
