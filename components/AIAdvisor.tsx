    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      {mode === 'ANALYZE' && (
        <div className="bg-white rounded-3xl shadow-soft border border-slate-100 overflow-hidden">
          <div className="bg-gradient-to-r from-brand-600 to-indigo-700 p-8 text-white relative overflow-hidden">
             {/* Decorative circles */}
          ...
          <div className="p-8">
            {!analysis ? (
              <div className="text-center py-12">
                 <div className="w-20 h-20 bg-brand-50 rounded-full flex items-center justify-center text-4xl mx-auto mb-6">⚡</div>
                 <button
